...
import { Notification, subscribeToNotifications, markNotificationAsRead, deleteNotification, createTestNotification } from '../lib/notificationService';
...
export default function NotificationDropdown() {
  ...
  const getTimeAgo = (timestamp: any) => {
    ...
    const now = new Date();
    const notificationDate = timestamp.toDate ? timestamp.toDate() : (timestamp as any).toDate();
