...
export default function Pricing() {
  ...
  const price = billingCycle === 'yearly' ? '19990 Rs' : '1999 Rs';
          ...
          <div className="flex items-center justify-center">
            <div className="inline-flex bg-gray-100 rounded-full p-2 shadow-inner">
              <button
                ...
                className={`px-8 py-3 rounded-full text-base font-semibold transition-all duration-300 ${billingCycle === 'monthly'
              ...
              <button
                ...
                className={`px-8 py-3 rounded-full text-base font-semibold transition-all duration-300 ${billingCycle === 'yearly'
                  ? 'bg-white text-gray-900 shadow-lg'
                  : 'text-gray-600 hover:text-gray-800'
                  }`}
              >
            ...
            <div className="w-full h-full rounded-2xl border border-gray-200 shadow-lg bg-white p-8 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-lg font-medium text-gray-500">/{billingCycle === 'yearly' ? 'year' : 'month'}</p>
                </div>
              ...
              <div className="text-center mb-8">
                ...
                <div className="mb-6">
                  <p className="text-4xl font-bold text-gray-900">
                    {billingCycle === 'yearly' ? '19990 Rs' : '1999 Rs'}
                  </p>
                  <p className="text-lg font-medium text-gray-500">/{billingCycle === 'yearly' ? 'year' : 'month'}</p>
                  {billingCycle === 'yearly' && (
                    <p className="text-sm font-semibold text-green-600 mt-1">Save 16% annually</p>
                  )}
                </div>
                <button
                  onClick={() => setIsCheckoutOpen(true)}
                  className="w-full max-w-xs rounded-full bg-blue-600 text-white py-4 font-semibold hover:bg-blue-700 transition-colors duration-200 text-base shadow-lg hover:shadow-xl"
                >
                  Upgrade Now
                </button>
              </div>
