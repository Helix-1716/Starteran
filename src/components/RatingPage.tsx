    ...
    return (
      <div className="flex items-center space-x-1">
        {[1, 2, 3, 4, 5].map((star) => (
          ...
          >
            <Star
              className={`w-6 h-6 ${star <= (interactive ? hoverRating || userRating : rating)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="h-full">
            <div className="h-full bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 flex flex-col">
              ...
              {submitted ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 mt-auto"
                  >
                    Submit Another Rating
                  </button>
                </div>
              ) : (
                <form onSubmit={handleRatingSubmit} className="flex-1 flex flex-col space-y-6">
                  <div>
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      ...
                      <span className="text-lg text-gray-600 font-medium w-24 text-left">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <textarea
                      ...
                      className="flex-1 w-full border-2 border-gray-200 rounded-2xl px-6 py-4 focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 resize-none text-lg min-h-[160px]"
          ...
          <div className="relative h-[600px] lg:h-full">
            <div className="absolute inset-0 bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 flex flex-col">
              <div className="text-center mb-8 shrink-0">
              ...
              <div className="flex-1 min-h-0 overflow-y-auto pr-4 -mr-4 space-y-6 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent hover:[&::-webkit-scrollbar-thumb]:bg-gray-400">
                {mockBotRatings.map((rating, index) => (
                  <div
                    key={rating.id}
                    className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 mx-1 mt-1"
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-3">
                          <h3 className="text-lg font-bold text-gray-900 truncate pr-2">{rating.name}</h3>
                          <span className="text-xs text-gray-500 bg-white border border-gray-200 px-3 py-1 rounded-full whitespace-nowrap">
                            {rating.date}
                          </span>
                        </div>
                        ...
                        <p className="text-gray-700 mb-4 text-sm md:text-base leading-relaxed">{rating.comment}</p>
